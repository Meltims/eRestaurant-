...
class ProductProvider with ChangeNotifier {
  ...
  List<ProductModel> productsByPromotion = [];
  ...
  Future loadProductsByPromotion({String promotionId}) async {
    productsByPromotion =
        await _productServices.getProductsByPromotion(id: promotionId);
    notifyListeners();
  }
