...
import 'package:eRestaurant/src/models/category.dart';
import 'package:eRestaurant/src/models/promotion.dart';
...
import 'package:eRestaurant/src/widgets/small_floating_button.dart';
...
class PromotionScreen extends StatelessWidget {
  ...
  const PromotionScreen({Key key, this.promotionModel}) : super(key: key);
            ...
            children: <Widget>[
              ...
              Positioned.fill(
                  ...
                  child: Align(
                      ...
                      child: CustomText(
                        text: "Average Price: \$" +
                            promotionModel.avgPrice.toString(),
                        color: white,
                        size: 18,
                        weight: FontWeight.w300,
                      ))),
                      ...
                      child: Container(
                        ...
                        child: Row(
                          children: <Widget>[
                            ...
                            Text(promotionModel.rating.toString()),
                          ],
                        ),
                      ),
                    ),
...
//              open & book section
          ...
          // products
          Column(
            children: productProvider.productsByPromotion
